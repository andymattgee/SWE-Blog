...
const Home = () => {
  ...
  return (
    ...
    //   <NavBar />
    //   <div className="relative absolute inset-0 flex flex-col  px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)] z-0">
    ...
    <div>
      <NavBar />
      <div className="h-screen relative absolute inset-0 flex flex-col justify-center items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)] z-0">
        <h2 className="z-10 text-white bg-clip-text text-6xl font-bold text-center">
          Welcome to the Home Page {userName}
        </h2>
        <br />
